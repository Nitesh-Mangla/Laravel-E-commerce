            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        ...
                        <a href="cart.html">Cart - <span class="cart-amunt">${{$totalPrice}}</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">{{$number}}</span></a>
            ...
            <div class="row">
               ...
               <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="{{ url('card') }}}">Cart</a></li>
                        @auth
                                    ...
                                    <tbody>
                                        ...
                                        <input type="hidden" name="product[]" value="{{$info->product_name}}">
                                            ...
                                            <td class="product-price">
                                                ...
                                                <span>$</span><span class="amount" id="price{{$info->id}}">{{$info->price}}</span> 
                                            </td>
                                            ...
                                            <td class="product-subtotal">
                                                <span>$</span><span class="amount" id="total{{$info->id}}">{{$info->price}}</span> 
                                            </td>
                                        </tr>
                                        <tr>
                                           @endforeach 
